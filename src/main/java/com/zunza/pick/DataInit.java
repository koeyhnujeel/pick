...
import com.zunza.pick.coupon.entity.DiscountType;
...
public class DataInit implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		String title = "테스트 이벤트입니다.";
		LocalDateTime startDt = LocalDateTime.now();
		LocalDateTime endDt = LocalDateTime.now().plusHours(1L);
		Event event = new Event(title, startDt, endDt);
